...
<body>
	...
	request영역에 에러메세지를 저장한 후 현재 페이지로 forward한다.
	...
	if(session.getAttribute("UserId") == null){
		/*
		session영역에 해당 속성이 있는지 확인한다. 만야 영역에 저장된
		정보가 없다면 '로그아웃' 상태이므로 로그인폼을 웹브라우저에 출력해야
		한다.
		*/
	...
	<!-- 
	로그인을 위한 <form>태그로 전공방식은 POST로 지정하고, submit 이벤트
